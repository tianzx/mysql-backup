...
# /backup/dbnames.txt and put databses names one on each line and assignd
# to DB_NAME variable.

DB_HOST = 'localhost'
DB_USER = 'root'
DB_USER_PASSWORD = 'Smartautotech@123'
...
# Checking if backup folder already exists or not. If not exists will
# create it.
